...
export default function BlockDetail() {
  ...
  if (error) return <div className="min-h-screen bg-ivory px-6 pt-[108px]"><ErrorState message={error}/></div>;
